...
|                 | `zephyr/drivers/ethernet/eth_dm9051_priv.h`                 | 暫存器定義與內部結構 |
...
| **範例**          | `samples/net/dhcpv4_client/overlay_nrf54l15_dm9051.overlay` | 應用配置範例     |

## Kconfig.dm9051 配置選項定義

```kconfig
CONFIG_ETH_DM9051=y                             # 啟用驅動
CONFIG_ETH_DM9051_DEBUG_PRINTS=n                # 封包處理超時
CONFIG_ETH_DM9051_RX_THREAD_STACK_SIZE=800      # RX 執行緒堆疊（預設）
CONFIG_ETH_DM9051_RX_THREAD_PRIO=2              # RX 執行緒優先權
```
